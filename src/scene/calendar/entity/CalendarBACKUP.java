...
public class CalendarBACKUP {
    ...
    private final String[] monthOfYear = {"Jan", "Feb", "March", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
    ...
    public String toString() {
        //return monthOfYear[date.get(GregorianCalendar.MONTH)].toUpperCase() + " " + date.get(GregorianCalendar.YEAR);
